...
//  }
  ...
  public static class endEffectorConstants{
    ...
    public static final double LeftScore = 0.3; //position when scoring on left
    public static final double RightScore = -0.135; //position when scoring on right
    public static final double LeftScoreL4 = 0.34; //position when scoring on left
    public static final double RightScoreL4 = -0.18; //position when scoring on right
