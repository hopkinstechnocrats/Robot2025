...
//  }
  ...
  public final class elevatorConstants{
    ...
    public static final double motorPowerResetLimit = .2; //percent of power used when elevator is going down
    ...
    public static final double L3Height = 13.25 + 23 + 2 + 3; //position when scoring on L3 inches
    public static final double L4Height = 21.75 + 38 + 6 + 0.8 + 2; //position when scoring on L4 inches
